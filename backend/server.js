...
/* ضغط الردود (gzip/brotli حسب اللي المتصفح بيقبله).
   الواجهة كلها نصوص: CSS مبني 87 كيلو، وجافاسكريبت 219 كيلو - والنص بيتضغط
   لحوالي خُمس حجمه. من غير السطر ده كل مستخدم كان بينزّل الحجم الكامل، وده
   بيبان بالذات على بيانات الموبايل البطيئة اللي أغلب مستخدمينا عليها. */
app.use(compression());
